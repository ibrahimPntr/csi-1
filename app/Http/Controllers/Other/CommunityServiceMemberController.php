...
class CommunityServiceMemberController extends Controller
{
    ...
    public function create(CommunityService $community_service)
    {
      ...
      return view('other.community_service_members.create',compact('exist','community_service','position','user'));
    }
    ...
    public function show(CommunityService $community_service)
    {
        ...
        return view('other.community_service_members.show', compact('community_service','community_service_schemas'));
