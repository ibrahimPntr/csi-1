...
@section('toolbar')
    {!! cui_toolbar_btn_delete(route('admin.community_services.destroy', [$community_service->id]), $community_service->id, 'icon-trash', 'Hapus Pengabdian', 'Anda yakin akan menghapus pengabdian ini?') !!}
    {!! cui_toolbar_btn(route('admin.community_services.edit', $community_service->id), 'icon-pencil', 'Edit Pengabdian') !!}
