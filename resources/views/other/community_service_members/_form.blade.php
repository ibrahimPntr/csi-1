<div class="form row">
  ...
  <div class="form-group">
      {{ html()->hidden('community_service_id')->value($community_service->id)->class(["form-control", "is-invalid" => $errors->has('community_service_id')])->id('community_service_id')->placeholder('Judul Pengabdian') }}
      @error('title')
