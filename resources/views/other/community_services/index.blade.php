                        ...
                        @foreach($community_services as $cs)
                            <tr>
                                ...
                                <td class="text-center">
                                    {!! cui_btn_view(route('community_services.show', [$cs->id])) !!}
                                    {!! cui_btn_edit(route('community_services.edit', [$cs->id])) !!}
                                    <a href="{{ route('community_service_members.show', [$cs->id]) }}" class="btn btn-sm btn-outline-primary">
                                        <i class="nav-icon icon-people"> </i>
                                    </a>
                                    {!! cui_btn_delete(route('community_services.destroy', [$cs->id]), "Anda yakin akan menghapus data pengabdian ini?") !!}
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
