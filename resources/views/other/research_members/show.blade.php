...
@section('toolbar')
    {!! cui_toolbar_btn(route('researches.edit', $research->id), 'icon-pencil', 'Edit Penelitian') !!}
...
<div class="row justify-content-center">
    <div class="col-md-12">
        <div class="card">
            ...
            {{-- CARD BODY--}}
            <div class="card-body">
              {!! cui_toolbar_btn(route('research_members.create',[$research->id]), 'icon-plus', 'Tambah Anggota') !!}
              <table class="table table-striped">
                  ...
                  @foreach($research->research_members as $member)
                      <tr>
                          ...
                          <td class="text-center">
                              {!! cui_btn_delete(route('research_members.destroy', [$member->id]), "Anda yakin akan menghapus data penelitian ini?") !!}
                          </td>
                      </tr>
                  @endforeach
                  </tbody>
